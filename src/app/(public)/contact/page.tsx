            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 items-start bg-white dark:bg-slate-950 p-6 rounded-2xl border border-slate-100 dark:border-slate-800/60 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-slate-800 dark:text-slate-200 mt-1 font-semibold text-sm">Changu Road, Bhaktapur, Nepal</p>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start bg-white dark:bg-slate-950 p-6 rounded-2xl border border-slate-100 dark:border-slate-800/60 shadow-sm">
                ...
                <div>
                  ...
                  <a href="tel:+9779848941404" className="text-slate-800 dark:text-slate-200 mt-1 font-semibold text-sm block hover:underline">
                    +977 9848941404
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start bg-white dark:bg-slate-950 p-6 rounded-2xl border border-slate-100 dark:border-slate-800/60 shadow-sm">
                ...
                <div>
                  ...
                  <a href="https://wa.me/9779848941404" target="_blank" rel="noopener noreferrer" className="text-slate-800 dark:text-slate-200 mt-1 font-semibold text-sm block hover:underline">
                    +977 9848941404
                  </a>
                </div>
              </div>
              ...
              <div className="flex gap-4 items-start bg-white dark:bg-slate-950 p-6 rounded-2xl border border-slate-100 dark:border-slate-800/60 shadow-sm">
                ...
                <div>
                  ...
                  <a href="mailto:harvestministriesnepal@gmail.com" className="text-slate-800 dark:text-slate-200 mt-1 font-semibold text-sm block hover:underline">
                    harvestministriesnepal@gmail.com
                  </a>
                </div>
              </div>
            </div>
